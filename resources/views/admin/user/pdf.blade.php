...
<head>
 ...
 <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-4bw+/aepP/YC94hEpVNVgiZdgIC5+VKNBQNGCHeKRQN+PtmoHDEXuppvnDJzQIu9" crossorigin="anonymous">
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/resume.css') }}" media="all" />
...
<div id="doc2" class="yui-t7">
	<div id="inner">
		...
		<div id="hd">
			<div class="yui-gc">
				<div class="yui-u first">
					<h1>PMII Komisariat Uninus</h1>
					<h2>Kartu Tanda Anggota</h2>
				</div>

				<div class="yui-u">
					<div class="contact-info">
      <img class="text-center" src="{{ asset('img/logokomi.png') }}" alt="logo-komi">
					</div><!--// .contact-info -->
				</div>
			</div><!--// .yui-gc -->
		</div><!--// hd -->
		...
		<div id="bd">
			<div id="yui-main">
				<div class="yui-b">
					...
					<div class="yui-gf">
						<div class="yui-u first">
       <img src="{{ asset('storage/img/' . $users->img ) }}" alt="foto-profile" style="width: 120px; height: 120px; object-fit: cover; border-radius: 20px; box-shadow: 2px 2px;">
						</div>
						<div class="yui-u">
      ...
      {!! QrCode::size(130)->generate('/qrcode/{{ $users->id }}') !!}
     </div>
