...
@section('content')
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url({{ asset('storage/home/homepage.jpg') }});">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Selamat Datang <br> Di Website PMII Uninus
                </h2>
            ...
            <div class="carousel-item" style="background-image: url({{ asset('storage/img/' . $hom->gambar) }});">
              <div class="carousel-container">
                <div class="container position-absolute top-50 start-50 translate-middle">
                  ...
                  <a href="{{ $hom->link }}" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get
                    Started</a>
                </div>
              </div>
            </div>
  ...
  <section id="about">
    <div class="container" data-aos="fade-up">
      ...
      <h6 class="text-center pr-2 pl-2">PMII merupakan organisasi gerakan dan kaderisasi yang berlandaskan islam
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row counters text-center">
        ...
        <div class="col text-center">
          <span data-purecounter-start="0" data-purecounter-end="{{ $user_mapaba }}" data-purecounter-duration="6"
            class="purecounter"></span>
          <p>Kader Pasca Mapaba</p>
        </div>

        <div class="col text-center">
          <span data-purecounter-start="0" data-purecounter-end="{{ $user_pkd }}" data-purecounter-duration="5"
            class="purecounter"></span>
          <p>Kader Pasca PKD</p>
        </div>

        <div class="col text-center">
          <span data-purecounter-start="0" data-purecounter-end="{{ $user_pkl }}" data-purecounter-duration="4"
            class="purecounter"></span>
          <p>Kader Pasca PKL</p>
        </div>

        <div class="col text-center">
          <span data-purecounter-start="0" data-purecounter-end="{{ $user_pkn }}" data-purecounter-duration="3"
            class="purecounter"></span>
          <p>Kader Pasca PKN</p>
        </div>
            ...
            new ApexCharts(document.querySelector("#reportsChart"), {
              series: [{
                  ...
                  data: [{{ $mapaba_2018 }}, {{ $mapaba_2019 }}, {{ $mapaba_2020 }},
                    {{ $mapaba_2021 }}, {{ $mapaba_2022 }}, {{ $mapaba_2023 }},
                    {{ $mapaba_2023 }}
                  ],
                },
  ...
  {{-- <div class="row p-5"> --}}
  <div class="p-4 row" data-aos="fade-up">
    <!-- Website Traffic -->
    ...
    <!-- Start Pie Chart -->
    <div class="col-6 mb-2" data-aos="fade-up">
      <div class="card">
        <div class="card-body">
    ...
    <div class="col-lg-12 mb-2" data-aos="fade-up">
      <div class="card">
        <div class="card-body">
          ...
          <script>
            document.addEventListener("DOMContentLoaded", () => {
              const formalData = [{{ $formalTeknik }}, {{ $formalHukum }}, {{ $formalFai }},
                {{ $formalFikom }}, {{ $formalFkip }}, {{ $formalEkonomi }}
              ];
              const nonFormalData = [{{ $nonformalTeknik }}, {{ $nonformalHukum }}, {{ $nonformalFai }},
                {{ $nonformalFikom }}, {{ $nonformalFkip }}, {{ $nonformalEkonomi }}
              ];
              const informalData = [{{ $informalTeknik }}, {{ $informalHukum }}, {{ $informalFai }},
                {{ $informalFikom }}, {{ $informalFkip }}, {{ $informalEkonomi }}
              ];
              ...
              <div class="portfolio-wrap">
                <figure>
                  <img src="{{ asset('storage/img/' . $galeri->img) }}" class="img-fluid" alt=""
                    style="width: 120%; height:120%; object-fit:cover; box-shadow: 0px 0px 5px 0px rgba(0,0,5,10);">
                  <a href="{{ asset('storage/img/' . $galeri->img) }}" data-lightbox="portfolio"
                    data-title="{{ $galeri->judul }}" class="link-preview"><i class="bi bi-plus"></i></a>
                  <a href="/galeri" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
                </figure>

                <div class="portfolio-info">
                  <h4>{{ $galeri->judul }}</h4>
                  <a href="/profile/{{ $galeri->user->slug }}">
                    <p style="text-transform: lowercase; text-decoration:none">
                      {{ $galeri->user->username }}</p>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="row portfolio-container pt-4 mt-4" data-aos="fade-up" data-aos-delay="200">
          ...
          @foreach ($recent_posts->take(3) as $post)
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <div class="portfolio-wrap">
                <figure>
                  <img src="{{ asset('storage/img/' . $post->image) }}" class="img-fluid" alt=""
                    style="width: 120%; height:120%; object-fit:cover; box-shadow: 0px 0px 5px 0px rgba(0,0,5,10);">
                  <a href="{{ asset('storage/img/' . $post->image) }}" data-lightbox="portfolio"
                    data-title="{{ $post->title }}" class="link-preview"><i class="bi bi-plus"></i></a>
                  <a href="{{ route('post', ['slug' => $post->slug]) }}" class="link-details" title="More Details"><i
                      class="bi bi-link"></i></a>
                </figure>

                <div class="portfolio-info">
                  <a href="{{ route('post', ['slug' => $post->slug]) }}">
                    <h4>{{ Str::limit($post->title, '35') }}</h4>
                  </a>
                  <a href="{{ route('category', $post->category->slug) }}">
                    <p style="text-transform: none; text-decoration:none">{{ $post->category->title }}
                    </p>
                  </a>
                </div>
              </div>
            ...
            @foreach ($quotes as $quote)
              <div class="swiper-slide">
                <div class="testimonial-item">
                  <img src="{{ asset('storage/img/' . $quote->img) }}" class="testimonial-img" alt=""
                    style="width: 110px; height:110px; object-fit:cover">
                  <h3>{{ $quote->name }}</h3>
                  <h4>{{ $quote->who }}</h4>
                  <p>
                    <img src="{{ asset('assets_user/img/quote-sign-left.png') }}" class="quote-sign-left"
                      alt="">
                    {{ $quote->quote }}
                    <img src="{{ asset('assets_user/img/quote-sign-right.png') }}" class="quote-sign-right"
                      alt="">
                  </p>
                </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="form">
          <form action="/contact/store" method="post">
            ...
            <div class="text-center"><button class="text-center btn btn-success" type="submit">Send
                Message</button></div>
          </form>
        </div>
