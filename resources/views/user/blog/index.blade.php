              ...
              <div class="owl-carousel main-carousel position-relative">
                ...
                <div class="position-relative overflow-hidden" style="height: 682px;">
                  ...
                  <div class="overlay">
                          ...
                          <a class="h3 m-0 text-white font-weight-bold text-decoration-none" href="{{ route('post', ['slug' => $post->slug]) }}">{{ $post->title }}</a>
                      </div>
                  </div>
                  @endforeach
              </div>
          ...
          <div class="row align-items-center bg-dark">
              <div class="col-12">
                  <div class="d-flex justify-content-between">
                      <div class="bg-danger text-light text-center font-weight-medium py-2" style="width: 170px;">Breaking News !!!!</div>
                      <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center ml-3"
                          style="width: calc(100% - 200px); padding-right: 100px;">
                          @foreach ($recent_posts->take(2) as $post)
                          <div class="text-truncate"><a class="text-white font-weight-semi-bold" href="{{ route('post', ['slug' => $post->slug]) }}">{{ Str::limit($post->title, 50) }}</a></div>
                          @endforeach
        ...
        <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            ...
                            <a class="text-secondary font-weight-medium text-decoration-none" href="https://www.nu.or.id/indeks">View All</a>
                        </div>
                    </div>
